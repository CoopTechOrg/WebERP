...
<div class="container estimate estimate-show">
        ...
        <div class="show__quotation">
            <div class="quotaion__container">
                ...
                <div class="quotation__summary">
                    ...
                    <div class="my-data">
                        <!-- TODO 自分の情報を呼び出す -->
                        <p class="my-name">{{__('田中 太郎')}}</p>
                        <p class="my-address">住所: {{__('東京都千代田区千代田１−１')}}</p>
                        <p class="my-tel">TEL: {{__('090-1111-2222')}}</p>
    ...
    <div class="estimate__save-control">
        <!-- TODO 発行,編集,保存処理 -->
        <button type="submit" class="common_control_btn save save_color"><i class="fas fa-file-alt common_icon_margin"></i>{{__('発行')}}</button>
        <a href="/home" class="common_control_btn delete neutral_color"><i class="fas fa-pen common_icon_margin"></i>{{__('編集')}}</a>
